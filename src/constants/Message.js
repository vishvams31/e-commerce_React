const message = {
    PASSWORD_REQUIREMENT_DID_NOT_MATCH: 'Password must be 8 to 32 characters long, contain at least one uppercase letter, one lowercase letter, one digit, and one special character.',
    EMAIL_NOT_VALID: "Please enter a valid email address",
    MOBILE_NOT_VALID: "Mobile number must be exactly 10 digits",
    FIELD_REQUIRED: "This field is required",
    PASSWORD_NOT_MATCH: "Passwords do not match",
    EMAIL_ALREADY_USED: "Email is already in use",
    USER_BOT_FOUND: "user not found",
